...
void PlayFab::ClientModels::FValidateAmazonReceiptRequest::writeJSON(JsonWriter& writer) const
{
    ...
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: ValidateAmazonReceiptRequest::CurrencyCode, PlayFab calls may not work if it remains empty."));
    }
    else
    {
...
void PlayFab::ClientModels::FValidateIOSReceiptRequest::writeJSON(JsonWriter& writer) const
{
    ...
    if (!CurrencyCode.IsEmpty() == false)
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: ValidateIOSReceiptRequest::CurrencyCode, PlayFab calls may not work if it remains empty."));
    }
    else
    {
        writer->WriteIdentifierPrefix(TEXT("CurrencyCode"));
